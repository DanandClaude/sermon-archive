...
- **Older analyses.** `worker/run.sh -m sermon_worker.tidy` hides repeats left by analyses run before this rule. It only touches entries the system found and nobody has edited, and the change is audited.
