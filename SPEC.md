...
- **D3 — Where do transcription and audio jobs run?** Options: managed GPU service; a hosted transcription API; a self-hosted worker (for example on the owner's Mac from the v1 app). Affects cost, speed and privacy.
